-- ================================================================
-- AppDian Migration 002 FIX: idempotente (se puede correr varias veces)
-- Ejecutar en Supabase → SQL Editor
-- ================================================================

-- 1. Columna "pagada" en facturas
...
DROP POLICY IF EXISTS "empresa_solo_sus_cierres" ON cierres_caja;
...
DROP POLICY IF EXISTS "empresa_solo_su_inventario" ON inventario;
...
DROP POLICY IF EXISTS "empresa_solo_sus_movimientos_inv" ON movimientos_inventario;
