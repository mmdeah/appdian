-- ================================================================
-- AppDian Migration 002: Caja Menor + Inventario + Cuentas por cobrar
-- Ejecutar en Supabase → SQL Editor
-- ================================================================

-- 1. Agregar columna "pagada" a facturas (para cuentas por cobrar)
...
CREATE INDEX IF NOT EXISTS idx_caja_menor_empresa_fecha
  ON caja_menor (empresa_id, fecha DESC);

-- RLS
ALTER TABLE caja_menor ENABLE ROW LEVEL SECURITY;

CREATE POLICY "empresa_solo_sus_movimientos" ON caja_menor
